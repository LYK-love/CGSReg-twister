...
```
git clone git@github.com:LYK-love/twister.git && cd twister
conda env create -f environment.yml
conda activate twister
```

For scheduler-based offline sweeps, Atari ROM import, and runtime directory
setup on a new machine, see [docs/environment.md](docs/environment.md).
...
# Training
--saving_period_epoch        type=int   default=10                      help="Model saving every 'n' epochs"
