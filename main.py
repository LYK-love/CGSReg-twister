...
if __name__ == "__main__":
    ...
    parser.add_argument("--wandb_project",              type=str,   default=os.environ.get("WANDB_PROJECT", "twister"),                 help="wandb project name")
    parser.add_argument("--wandb_entity",               type=str,   default=os.environ.get("WANDB_ENTITY"),                             help="wandb entity")
    ...
    # Training
    parser.add_argument("--saving_period_epoch",        type=int,   default=10,                                                         help="Model saving every 'n' epochs")
